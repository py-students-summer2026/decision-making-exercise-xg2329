...
def print_question(die_1_value, die_2_value, question_type):
    ...
    if question_type == "sum":
        print(
            "You rolled a {d1} and a {d2}... What is the sum of {d1} and {d2}?".format(
                d1=die_1_value,
                d2=die_2_value
            )
        )
        ...
        print(
            "You rolled a {d1} and a {d2}... What is the difference between {d1} and {d2}?".format(
                d1=die_1_value,
                d2=die_2_value
            )
        )
...
def print_correct_answer(die_1_value, die_2_value, question_type):
    ...
    if question_type == "sum":
        ...
        print(
            "No! The sum of {} and {} is {}!".format(
                die_1_value, die_2_value, answer
            )
        )
    else:
        answer = abs(die_1_value - die_2_value)
        print(
            "No! The difference between {} and {} is {}!".format(
                die_1_value, die_2_value, answer
            )
        )
